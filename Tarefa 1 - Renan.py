...
def main():
    ...
    modo = input("Deseja jogar o modo 1 ou 2? ")
    while modo not in ['1', '2']:
        modo = input("Entrada inválida. Digite 1 ou 2: ")
    ...
    while not game_over:
        ...
        if current_player == "Computador":
            ...
            try:
                col = int(input(f"{current_player} ({piece}), escolha uma coluna (0-6): "))
            except ValueError:
            ...
            if not is_valid_location(board, col):
                print("Jogada inválida! Coluna cheia ou índice inexistente. Tente novamente.\n")
                continue
